...
// IntoCommand Impls
impl crate::exec::script::IntoCommand for ServiceUpdateBuilder<'_> {
...
impl crate::exec::script::IntoCommand for ServiceScaleBuilder<'_> {
    fn build_str(&self) -> String {
        self.args.preview()
    }
}

impl crate::exec::script::IntoCommand for ServiceRollbackBuilder<'_> {
    fn build_str(&self) -> String {
        let mut a = self.args.clone();
        a.push(&self.name);
        a.preview()
