...
impl<'a> SwarmHandle<'a> {
    ...
    pub async fn inspect(&self) -> DockerResult<crate::docker::SwarmInfo> {
        self.cli
    ...
    ) -> DockerResult<crate::docker::SwarmInfo> {
        self.cli
...
impl crate::exec::script::IntoCommand for SwarmActiveBuilder<'_> {
