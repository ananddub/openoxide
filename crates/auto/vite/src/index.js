...
function loadManifest(root) {
  ...
  const stdout = execFileSync('cargo', ['run', '--quiet', '--manifest-path', cargo, '--bin', 'openoxide-live-manifest'], {encoding: 'utf8'});
...
export function openoxide() {
  ...
  return {
    ...
    configResolved(config) {
      ...
      writeFileSync(resolve(config.root, 'src/openoxide-live.generated.d.ts'), declarationSource(manifest));
    },
