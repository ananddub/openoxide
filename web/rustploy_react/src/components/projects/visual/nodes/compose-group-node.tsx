...
export function ComposeGroupNode({data}: NodeProps<ComposeGroupNodeProps>) {
	...
	return (
		<div
			...
			style={{
				...
				boxShadow: hov && !data.expanded ? '0 0 0 3px rgba(167,139,250,0.08)' : 'none',
				userSelect: 'none',
			}}
		>
			{/* Header */}
			...
			<Handle type="target" position={Position.Left}
				style={{left: -7, width: 12, height: 12, background: '#1a1a2e', border: '2px solid #a78bfa', borderRadius: '50%'}} />
			<Handle type="source" position={Position.Right}
				style={{right: -7, width: 12, height: 12, background: '#1a1a2e', border: '2px solid #a78bfa', borderRadius: '50%'}} />
		</div>
	);
}
