...
export interface components {
	schemas: {
		...
		PrivateNetworkProviderDto:
			...
			| 'CUSTOM';
		/** @enum {string} */
		PrivateNetworkRotationStateDto:
			| 'IDLE'
			| 'ROTATING'
			| 'ROLLING_BACK'
			| 'FAILED';
		/** @enum {string} */
		PrivateNetworkStatusDto:
			| 'DISABLED'
			| 'CONFIGURING'
			| 'ACTIVE'
			| 'FAILED';
