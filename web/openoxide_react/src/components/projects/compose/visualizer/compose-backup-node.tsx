...
export function ComposeBackupNode({data, selected}: NodeProps<Node<VolumeBackupData>>) {
	...
	return (
		<div style={{
			...
			<Handle type="target" position={Position.Left}
				style={{width: 7, height: 7, background: '#38bdf8', border: '2px solid #0a1624', left: -4}} />
			...
			<div style={{
				...
				<span style={{
					fontSize: 11, fontWeight: 700, color: '#f0f9ff',
				...
				<div style={{display: 'flex', alignItems: 'center', gap: 3.5}}>
					...
					<span style={{
						fontSize: 9.5, fontWeight: 600, fontFamily: 'monospace', color: '#94a3b8',
						whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis',
					}}>
						{volName}
					</span>
				...
				<div style={{display: 'flex', alignItems: 'center', gap: 3.5}}>
					...
					<span style={{
						fontSize: 9.5, fontWeight: 600, fontFamily: 'monospace', color: '#38bdf8',
						whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis',
					}}>
						{schedText}
					</span>
